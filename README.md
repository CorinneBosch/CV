...
| [Zwitscher](https://github.com/CorinneBosch/chitter-challenge) | Started as Makers weekend challenge, attempting to produce a lightweight clone Twitter. (Zwitscher is the Swiss-German translation for Twitter) | Ruby on Rails, Active Record, Rspec, Capybara |        |
...
<!-- | [Bank Tech Test](https://github.com/CorinneBosch/bank-tech-test) | Tech test exercises demonstrating TDD and code quality. | Ruby, Rspec |        | -->
<!-- | [MakersBnB](https://github.com/CorinneBosch/mk_bnb) | Our first Makers group project, replicating Airbnb over the course of 5 days in Ruby. | Ruby, Active Record, Rspec, Capybara |        | -->
